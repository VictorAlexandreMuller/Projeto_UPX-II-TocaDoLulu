...
public class JDialogTeste extends javax.swing.JDialog {

    private Tutores tutor;
    PainelTutoresJIFF main;
    boolean isEditar = false;
        
    public JDialogTeste(java.awt.Frame parent, boolean modal, PainelTutoresJIFF main) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogTeste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogTeste dialog = new JDialogTeste(new javax.swing.JFrame(), true, null);
