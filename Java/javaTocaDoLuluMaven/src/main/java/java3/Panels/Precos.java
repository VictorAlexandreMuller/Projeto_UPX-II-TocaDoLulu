...
public class Precos extends javax.swing.JFrame {
    ...
    private static Precos myInstance;

    public static Precos getInstance() {
        if (myInstance == null) {
            myInstance = new Precos();
        } return myInstance;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Precos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
