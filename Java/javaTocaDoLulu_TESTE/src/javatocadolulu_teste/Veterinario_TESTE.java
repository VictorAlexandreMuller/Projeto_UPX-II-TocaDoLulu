...
public class Veterinario_TESTE {
    ...
    public Veterinario_TESTE() {
    }

    public Veterinario_TESTE(String documento_identificador, String tipo_documento, String nome, char nascimento, int celular) {
